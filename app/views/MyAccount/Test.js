...
const captchaUrl = "https://tenedores-63e1a.firebaseapp.com/captcha.html";// link to your captcha.html
//https://developers.facebook.com/docs/accountkit/webjs
//https://numverify.com/product
...
export default class PhoneAuthTest extends React.Component {
    ...
    _sendConfirmationCode = (captchaToken) => {
        console.log("_sendConfirmationCode");

        this.setState({ showModal: false });
        let number = `+569${this.state.input_value}`;
        console.log(number);
